...
function animate() {
  // TO DO: move the marker on the map every 1000ms. Use the function marker.setLngLat() to update the marker coordinates.
  ...
  setTimeout(() => {
    ...
    counter++;
    animate();  // Trigger another timeout.
  }, 1000);
}
